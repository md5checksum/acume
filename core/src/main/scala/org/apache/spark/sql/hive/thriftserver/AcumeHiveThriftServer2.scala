 ...
 */
object AcumeHiveThriftServer2 extends Logging {
  ...
  def startWithContext(sqlContext: HiveContext): Unit = {
    val server = new AcumeHiveThriftServer2(sqlContext)
  ...
  def main(args: Array[String]) {
    ...
    try {
      val server = new AcumeHiveThriftServer2(SparkSQLEnv.hiveContext)
...
private[hive] class AcumeHiveThriftServer2(hiveContext: HiveContext)
  extends HiveServer2
  ...
  override def init(hiveConf: HiveConf) {
    val sparkSqlCliService = new AcumeSparkSQLCLIService(this, hiveContext)
