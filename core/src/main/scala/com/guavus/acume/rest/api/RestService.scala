...
class RestService {
  ...
  def exportSqlAggregateData(dataExportRequest: DataExportRequest, @QueryParam(value = "super") userinfo: String,
	...
	def getDataAvailability( @QueryParam(value = "super") userinfo : String,
	  ...
	  list.add(AcumeContextTrait.acumeContext.get.ac.cacheConf.getLong("acume.cache.delete.firstbinpersistedtime").get)
	  list.add(AcumeContextTrait.acumeContext.get.ac.cacheConf.getLong("acume.cache.delete.lastbinpersistedtime").get)
