...
//    }
    ...
    val orc_searchIngressCustCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchIngressCustCubeDimension.orc")
    val orc_searchIngressCustCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchIngressCustCubeMeasure.orc")
    val orc_DummyCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/DummyCubeDimension.orc")
    val orc_DummyCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/DummyCubeMeasure.orc")
    val orc_SearchPRI_InteractionIngressDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/SearchPRI_InteractionIngressDimension.orc")
    val orc_SearchPRI_InteractionIngressMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/SearchPRI_InteractionIngressMeasure.orc")
    val orc_searchEgressCustCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressCustCubeDimension.orc")
    val orc_searchEgressCustCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressCustCubeMeasure.orc")
    val orc_searchEgressEntityCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressEntityCubeDimension.orc")
    val orc_searchEgressEntityCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressEntityCubeMeasure.orc")
    val orc_searchEgressPeerCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressPeerCubeDimension.orc")
    val orc_searchEgressPeerCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressPeerCubeMeasure.orc")
    val orc_searchEgressProsCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressProsCubeDimension.orc")
    val orc_searchEgressProsCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchEgressProsCubeMeasure.orc")
    val orc_SearchPRI_InteractionEgressDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/SearchPRI_InteractionEgressDimension.orc")
    val orc_SearchPRI_InteractionEgressMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/SearchPRI_InteractionEgressMeasure.orc")
    val orc_searchIngressEntityCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchIngressEntityCubeDimension.orc")
    val orc_searchIngressEntityCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchIngressEntityCubeMeasure.orc")
    val orc_searchIngressProsCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchIngressProsCubeDimension.orc")
    val orc_searchIngressProsCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchIngressProsCubeMeasure.orc")
    val orc_searchPrefixEgressCustCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixEgressCustCubeDimension.orc")
    val orc_searchPrefixEgressCustCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixEgressCustCubeMeasure.orc")
    val orc_searchPrefixEgressPeerCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixEgressPeerCubeDimension.orc")
    val orc_searchPrefixEgressPeerCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixEgressPeerCubeMeasure.orc")
    val orc_searchPrefixEgressProsCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixEgressProsCubeDimension.orc")
    val orc_searchPrefixEgressProsCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixEgressProsCubeMeasure.orc")
    val orc_searchPrefixIngressCustCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixIngressCustCubeDimension.orc")
    val orc_searchPrefixIngressCustCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixIngressCustCubeMeasure.orc")
    val orc_searchPrefixIngressPeerCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixIngressPeerCubeDimension.orc")
    val orc_searchPrefixIngressPeerCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixIngressPeerCubeMeasure.orc")
    val orc_searchPrefixIngressProsCubeDimension = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixIngressProsCubeDimension.orc")
    val orc_searchPrefixIngressProsCubeMeasure = sparkContext.newAPIHadoopFile[NullWritable, OrcStruct, OrcNewInputFormat]("/data/orc/searchPrefixIngressProsCubeMeasure.orc")
