...
create table Filter (id integer generated by default as identity (start with 1), description varchar(255), filterMap blob, moduleId varchar(255) not null, name varchar(255), responseFilters blob, searchRequest blob, version integer not null, userName varchar(255), primary key (id));
...
create table Role (id integer generated by default as identity (start with 1), roleName varchar(255), version integer not null, primary key (id), unique (roleName));
...
#VER 3.7.6.1
create table DimensionPermissionData (userId varchar(255) not null, dimensionValue blob, primary key (userId));
#VER 3.7.7.3
...
create table userhistory (id integer generated by default as identity (start with 1), username varchar(255) not null, password varchar(255) not null, creationtimestamp timestamp(0) not null, primary key (id), constraint ON_USER_DELETE_CONST foreign key (username) references UserInfo on delete cascade)
