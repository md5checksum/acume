...
import com.guavus.equinox.query.data.Table;
...
public class AggregateResponse implements Serializable {
    ...
    */
	...
	public String toString() {
		final int maxLen = EquinoxConfiguration.MaxLength.getIntValue();
	...
	private void applyEncryption() {
		HashSet<String> encryptedDimensions = new HashSet<String>(Arrays.asList(EquinoxConfiguration.EncryptedDimensions.getStringArray(";")));
		HashSet<String> encryptedMeasures = new HashSet<String>(Arrays.asList(EquinoxConfiguration.EncryptedMeasures.getStringArray(";")));
