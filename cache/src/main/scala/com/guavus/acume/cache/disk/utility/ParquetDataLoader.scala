 ...
 *
 */
class ParquetDataLoader(acumeCacheContextTrait: AcumeCacheContextTrait, conf: AcumeCacheConf, acumeCache: AcumeCache) extends BasicDataLoader(acumeCacheContextTrait, conf, acumeCache) { 
